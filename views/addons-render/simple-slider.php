<?php if ($shortcodes): ?>
	<div class="simple-slider owl-carousel owl-theme" id="<?php echo $id; ?>" data-responsive='<?php echo $responsive; ?>' data-nav="<?php echo $display_nav ? 1 : 0; ?>" data-dots="<?php echo $display_dots ? 1 : 0; ?>">
